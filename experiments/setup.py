...
def run_normalization_experiments(eval: bool = False):
    ...
    grid_search(options_normalization_min, data, result_file_normalize, append_result=True)
    ...
    grid_search(options_normalization_max, data, result_file_normalize, append_result=True)
    if eval:
...
def run_min_size_experiments(eval: bool = False):
    ...
    options_min_size = {
        "min_size": [
            50, 100, 200, 300, 400, 500, 600, 700, 800, 900, 1000, 1200, 1400, 1600, 1800, 2000, 3000, 4000, 5000, 6000,
            7000, 8000, 9000, 10000, 12000, 14000, 16000, 18000, 20000, 25000, 30000, 35000, 40000, 45000, 50000, 55000,

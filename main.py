...
if __name__ == "__main__":
    ...
    if __name__ == "__main__":
        ...
        for image_idx, image_path in enumerate(image_paths):
            ...
            optimize_parameters(options_cellprob_threshold, image_path, result_file_cellprob_threshold, append_result=image_idx > 0)
            ...
            optimize_parameters(options_stitch_threshold, image_path, result_file_stitch_threshold, append_result=image_idx > 0)
